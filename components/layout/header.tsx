        ...
        <div className="flex items-center gap-2 relative">
          {user ? (
            <>
              {/* Avatar button */}
              {user?.role === 'client' && (<>
                <button onClick={() => router.push("/post-job")} className="inline-flex items-center justify-center rounded-2xl text-sm font-medium px-3 py-2 transition-colors border bg-neutral-900 text-white border-neutral-900 hover:opacity-90">Post a mini‑job</button>
              </>)
              }
              <button
