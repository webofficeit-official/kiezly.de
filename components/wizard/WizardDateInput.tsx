...
export function WizardDateInput({ label, value, onChange, required, error }: WizardDateInputProps) {
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-xs">
            ...
            {days.map((day) => (
              <button
                ...
                className={`rounded-lg px-2 py-1 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 ${value && isSameDay(new Date(value), day)
                    ? "bg-black text-white"
