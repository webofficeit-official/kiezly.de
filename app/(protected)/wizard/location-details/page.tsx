                    ...
                    <Card className="lg:col-span-3 space-y-4">
                        <div className="grid grid-cols-12 gap-4">
                            ...
                            <div className="col-span-12 sm:col-span-6 lg:col-span-7 bg-white p-6">
                                {/* --- Header --- */}
                                <WizardHeader title="Location Details" description="Provide location details" />
                                ...
                                <div className="mt-5">
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        />
                                        <WizardInput label="Postal Code" placeholder="10707" value='' onChange={() => { }} />
                                    </div>
                                    <div className="flex flex-col md:flex-row">
                                        <WizardInput label="Street" placeholder="Essen" value='' onChange={() => { }} />
                                        <WizardInput label="City" placeholder="Reg.-Bez. Düsseldorf" value='' onChange={() => { }} />
                                        <WizardInput label="State" placeholder="Nordrhein-Westfalen" value='' onChange={() => { }} />
                                    </div>
                                    <div className="flex flex-col md:flex-row">
                                        <WizardInput label="Latitude" placeholder="51.4535" value='' onChange={() => { }} />
                                        <WizardInput label="Longitude" placeholder="7.0102" value='' onChange={() => { }} />
                                    </div>
                                    <WizardDirection next prev prevLink="/wizard/job-details" nextLink="/wizard/pricing-details" />
                                </div>
                            </div>
                        </div>
                    </Card>
