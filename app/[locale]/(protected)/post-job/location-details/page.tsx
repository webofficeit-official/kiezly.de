...
export default function Page() {
  ...
  const validateFields = () => {
    ...
    if (!formData.country_id)
      newErrors.country_id = t("location.validation.country_required");
    if (!formData.postal_code?.trim())
      newErrors.postal_code = t("location.validation.postal_code_required");
    if (!formData.street?.trim())
      newErrors.street = t("location.validation.street_required");
    if (!formData.city?.trim())
      newErrors.city = t("location.validation.city_required");
    if (!formData.state?.trim())
      newErrors.state = t("location.validation.state_required");
    setErrors(newErrors);
    return newErrors;
  };
